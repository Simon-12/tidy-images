...
public:
    explicit HeaderModel(QList<QString> &header, QObject *parent = nullptr);

    enum HeaderRoles { NameRole = Qt::UserRole + 1, FilterRole, DirectionRole };
