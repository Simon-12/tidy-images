...
public:
    ...
    Q_PROPERTY(bool databaseActive READ getDatabase WRITE setDatabase NOTIFY databaseChanged)
    Q_PROPERTY(bool favorite READ getFavorite NOTIFY favoriteChanged)
    Q_PROPERTY(QStringList status READ getStatus NOTIFY indexChanged)
