...
ApplicationInfo::ApplicationInfo(QObject *parent) : QObject(parent) {
    ...
    m_about =
        ...
        "<br><br>"
        "If you like the application and would like to support it, you can donate via PayPal or BTC: ";

    m_story =
        "This application has been released in the hope that someone will find it useful and inspiring. "
        "It was originally developed for my wife, "
        "to sort her beautiful camera pictures and find her favourite memories in a well organised database. "
        "<br><br>"
    ...
    m_license =
        "Copyright © 2015 Simon Schwarzkopf"
        "<br><br>"
        "Licensed under the "
    ...
    m_QtInfo = "This program uses Qt version " + QString(QT_VERSION_STR) +
               "<br><br>"
    ...
    m_font = "<a href='https://fonts.google.com/specimen/Roboto'>Google Fonts Roboto</a>";
