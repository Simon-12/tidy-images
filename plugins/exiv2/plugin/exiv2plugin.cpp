...
void Exiv2Plugin::exifPrint(const QString &path)
{
    ...
    Exiv2::Image::AutoPtr image = readImage(path);
...
void Exiv2Plugin::readMetadata(const QString &path)
{
    m_metadata = readImage(path);
}
...
Exiv2::Image::AutoPtr Exiv2Plugin::readImage(const QString &path)
{
